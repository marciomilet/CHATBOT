...
class Chatbot:
    def __init__(self, master):
        ...
        # Campo de entrada
        self.entry = ctk.CTkEntry(master, width=400, placeholder_text="Digite o id do usuário...")
...
########################################################################
    def get_response(self, user_input):
        ...
        try:
            response = requests.get("https://docs.google.com/spreadsheets/d/e/2PACX-1vQIVaHcTlB62Tj29WEEhYXGAFx1mhwxstWtMAcvnsUemD_acuLrooLn3MC-T2KOGYexC_ctIPsKZPVx/pubhtml?gid=2900213&single=true")
            if response.status_code == 200:
                soup = BeautifulSoup(response.text, 'html.parser')
                rows = soup.find_all('tr')
#########################################################################
                # Procurar por id na tabela
